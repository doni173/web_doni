...
<body>
    ...
    <div class="main-container">
        <div class="main-content">
            ...
            <div class="buttons">
                <form action="{{ route('brands.index') }}" method="GET" class="search-form" id="searchForm">
                    <div class="search-input-wrapper">
                        <input type="text" class="form-control" placeholder="Cari brand..." name="q" value="{{ request('q') }}" id="searchInput" autocomplete="off">
                    ...
                    <button type="button" class="btn-add" data-toggle="modal" data-target="#addBrandModal">
            ...
            <div class="table-responsive">
                <table class="table-main">
                    ...
                    <tbody id="brandTableBody">
                        ...
                        <tr>
                            <td data-label="ID Brand">
                                <span class="id-badge">{{ $brand->id_brand }}</span>
                            </td>
                            <td data-label="Brand">
                                <span class="product-name">{{ $brand->brand }}</span>
                            </td>
                            <td data-label="Aksi">
                                <div class="action-buttons">
                                    <button type="button" class="btn-edit" data-toggle="modal" data-target="#editBrandModal{{ $brand->id_brand }}" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <button type="button" class="btn-delete" onclick="confirmDelete('{{ $brand->id_brand }}')" title="Hapus">
                ...
                <div class="modal-body">
                    <form action="{{ route('brands.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="brand" name="brand" placeholder="Masukkan nama brand" required>
                        </div>
    ...
    <div class="modal fade" id="editBrandModal{{ $brand->id_brand }}" tabindex="-1" role="dialog" aria-labelledby="editBrandModalLabel{{ $brand->id_brand }}" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editBrandModalLabel{{ $brand->id_brand }}">
                ...
                <div class="modal-body">
                    <form action="{{ route('brands.update', $brand->id_brand) }}" method="POST">
                        ...
                        @method('PUT')
                        <div class="form-group">
                            <label for="brand{{ $brand->id_brand }}">Nama Brand</label>
                            <input type="text" class="form-control" id="brand{{ $brand->id_brand }}" name="brand" value="{{ $brand->brand }}" required>
                        </div>
                        <div class="modal-footer-custom">
                            <button type="button" class="btn-secondary" data-dismiss="modal">Batal</button>
                            <button type="submit" class="btn-success">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function initPagination() {
                ...
                allRows = Array.from(document.querySelectorAll('#brandTableBody tr')).filter(row => {
